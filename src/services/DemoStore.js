...
import { getLandmarkXP } from '../constants/game';
import { DEFAULT_AVATAR_ID } from '../constants/profile';
import { LANDMARK_TYPES } from '../constants/game';
...
const normalizeUser = record =>
  record
    ? {
        ...
        notificationTypes: Array.isArray(record.notificationTypes)
...
class DemoStore {
  ...
  recordCheckIn(userId, landmarkId, landmarkType, landmarkMeta = {}) {
